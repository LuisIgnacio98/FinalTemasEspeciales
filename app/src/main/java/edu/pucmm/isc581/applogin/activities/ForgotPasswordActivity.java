...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(v -> {
            Intent i = new Intent(v.getContext(), edu.pucmm.isc581.applogin.activities.RegisterActivity.class);
            startActivity(i);
        });

        login.setOnClickListener(v -> {
            Intent i = new Intent(v.getContext(), edu.pucmm.isc581.applogin.activities.LoginActivity.class);
            startActivity(i);
        });
